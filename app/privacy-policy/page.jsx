  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {policies.map((policy, index) => (
            <div 
              key={policy.title} 
              className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm dark:shadow-gray-900/20 hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-green-200 p-8"
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4 group-hover:text-green-600 transition-colors duration-300">
                {policy.title}
              </h3>
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-white dark:bg-gray-800 bg-opacity-20 rounded-full mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/about" 
                className="inline-flex items-center px-6 py-3 border border-white border-opacity-30 rounded-lg text-white hover:bg-white dark:bg-gray-800 hover:bg-opacity-10 transition-colors duration-200"
              >
                Learn More About Us
              </a>
              <a 
                href="/" 
                className="inline-flex items-center px-6 py-3 bg-white dark:bg-gray-800 text-green-600 rounded-lg hover:bg-gray-100 dark:bg-gray-800 transition-colors duration-200"
              >
                Back to Home
              </a>
            </div>
