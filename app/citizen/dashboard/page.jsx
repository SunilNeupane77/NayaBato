...
export default function CitizenDashboard() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default: return 'bg-gray-100 dark:bg-gray-800 text-gray-800 border-gray-200';
    }
  };

  // Calculate chart data
  const rejectedCount = stats.myIssues - stats.resolved - stats.pending;
  const chartData = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-teal-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 space-y-6 lg:space-y-8">
        {/* Header */}
        <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 rounded-2xl p-6 sm:p-8 text-white shadow-xl">
          ...
          <div className="relative flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <Button asChild className="bg-white text-teal-600 hover:bg-gray-50 font-semibold shadow-lg w-full sm:w-auto transition-all hover:scale-105">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-yellow-50 to-amber-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-indigo-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          {/* Left Column: Recent Issues & Chart */}
            ...
            <Card className="border-0 shadow-lg bg-white">
              ...
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                  <Button asChild variant="outline" className="h-24 flex-col border-2 border-teal-100 hover:border-teal-400 hover:bg-teal-50 transition-all duration-300 group">
                    <Link href="/issues/report">
                      ...
                      <span className="text-xs font-medium">{t('citizen.dashboard.reportIssue')}</span>
                    </Link>
                  </Button>

                  <Button asChild variant="outline" className="h-24 flex-col border-2 border-blue-100 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 group">
                    <Link href="/issues">
                      ...
                      <span className="text-xs font-medium">{t('citizen.dashboard.browseIssues')}</span>
                    </Link>
                  </Button>

                  <Button asChild variant="outline" className="h-24 flex-col border-2 border-purple-100 hover:border-purple-400 hover:bg-purple-50 transition-all duration-300 group">
                    <Link href="/citizen/my-reports">
                      ...
                      <span className="text-xs font-medium">{t('citizen.dashboard.myReports')}</span>
                    </Link>
                  </Button>

                  <Button asChild variant="outline" className="h-24 flex-col border-2 border-green-100 hover:border-green-400 hover:bg-green-50 transition-all duration-300 group">
                    <Link href="/citizen/community">
                      ...
                      <span className="text-xs font-medium">{t('citizen.dashboard.community')}</span>
                    </Link>
                  </Button>
                </div>
              </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {stats.achievements.slice(0, 3).map((achievement, index) => (
                      <div key={index} className="flex items-center gap-3 bg-white/60 p-3 rounded-lg border border-yellow-200">
                        <div className="w-10 h-10 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full flex items-center justify-center shadow-sm flex-shrink-0">
